...
// CORREGIDO CON COLUMNAS REALES DE LA BD
// ============================================
...
class Producto extends BaseModel {
    ...
    async checkStock(id_producto, talla, cantidad = 1) {
        try {
            ...
            return {
                ...
                id_talla_producto: rows[0].id_talla_producto
            };
        } catch (error) {
     ...
     */
    async updateStock(id_talla_producto, cantidad, operation = 'subtract') {
        try {
            ...
            const [result] = await this.db.execute(query, [cantidad, id_talla_producto, minStock]);
